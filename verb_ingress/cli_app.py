...
logging_config_helper = importlib.import_module('misc.logger.logging_config_helper')
...
async def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python -m verb_ingress.cli_app -q "what api should I use to book an alaska airline flight?" --num-results 10 
  python -m verb_ingress.cli_app -q "what api should I use to book an alaska airline flight?" --num-results 10 --format json
  """
    )
