...
from verb_ingress.factory import auto_select_strategy, get_available_strategies
import importlib

# from retrieval.retriever import get_vector_db_client
retriever = importlib.import_module('core.retriever')
get_vector_db_client = retriever.get_vector_db_client


#from embedding.embedding import batch_get_embeddings
embedding = importlib.import_module('core.embedding')
batch_get_embeddings = embedding.batch_get_embeddings
...
async def delete_site_from_database(site: str, database: str = None):
    ...
    endpoint_name = database or CONFIG.write_endpoint #CONFIG.preferred_retrieval_endpoint
...
async def process_with_ingress_system(file_path: str, site: str, batch_size: int = 100,
    ...
    try:
        ...
        if file_path.lower().endswith('.itfc'):
            from verb_ingress.java_strategy import JavaStrategy
...
async def process_url_with_ingress_system(url: str, site: str, batch_size: int = 100,
    ...
    try:
        from verb_ingress.openapi_strategy import OpenAPIStrategy
  ...
  python db_load.py --force-recompute file.json my-site
    ...
    if args.url_list or args.force_recompute:
        ...
        try:
            ...
            data_loading = importlib.import_module('core.data_loading')
            db_load = data_loading.db_load
